...
gboolean bd_btrfs_create_volume (gchar **devices, gchar *label, gchar *data_level, gchar *md_level, BDExtraArg **args, GError **error);
gboolean bd_btrfs_add_device (gchar *mountpoint, gchar *device, BDExtraArg **args, GError **error);
